...
namespace Dav1dDotnet.Dav1d.Definitions
{
    ...
    public delegate void FreeCallback(IntPtr data, IntPtr userData);
    ...
    public unsafe struct Dav1dFrameHeader
    {
        ...
        public int _width_coded;
        public int _width_superresolution_upscaled;
        public int _height;
    ...
    public struct Dav1dPicture
    {
        ...
        public IntPtr frame_hdr_ref; // Dav1dFrameHeader allocation origin
